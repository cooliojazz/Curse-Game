function initializeCoreMod() {
	...
	return {
		"MonumentCoreRoomTransformer": {
			"target": {
				"type": "METHOD",
				"class": "net.minecraft.world.gen.feature.structure.OceanMonumentPieces$MonumentCoreRoom",
			...
			"transformer": function(method) {
				...
				var instructions = ASMAPI.listOf(
						...
						new IntInsnNode(Opcodes.ALOAD, 5),
								ASMAPI.buildMethodCall("com/up/cursegame/asm/MonumentCoreRoomTransformer", "postPostProcess", "(Lnet/minecraft/world/gen/feature/structure/OceanMonumentPieces$MonumentCoreRoom;Lnet/minecraft/world/ISeedReader;Lnet/minecraft/util/math/MutableBoundingBox;)V", ASMAPI.MethodType.STATIC));
