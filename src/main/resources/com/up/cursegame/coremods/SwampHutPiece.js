function initializeCoreMod() {
	...
	return {
		"SwampHutPieceTransformer": {
			"target": {
				"type": "METHOD",
				"class": "net.minecraft.world.gen.feature.structure.SwampHutPiece",
//				"methodName": "postProcess",
			...
			"transformer": function(method) {
				...
				var instructions = ASMAPI.listOf(
						...
						ASMAPI.buildMethodCall("com/up/cursegame/asm/SwampHutPieceTransformer", "postPostProcess", "(Lnet/minecraft/world/gen/feature/structure/SwampHutPiece;Lnet/minecraft/world/ISeedReader;Lnet/minecraft/util/math/MutableBoundingBox;)V", ASMAPI.MethodType.STATIC));
